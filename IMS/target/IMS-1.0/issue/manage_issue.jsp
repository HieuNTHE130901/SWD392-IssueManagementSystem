                    ...
                    <div style="display: flex; justify-content: center;">
                        ...
                        <script>
                            function openAddIssue() {
                                window.location.href = "/IMS/add-issue";
                            }
                        ...
                        <table border="1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit-issue?issueId=<%= issue.getIssueId() %>&projectID=<%= issue.getProjectId() %>&createdBy=<%= issue.getCreatedBy() %>" class="action-button1">Edit</a>
                                        <a href="view-issue-details?issueId=<%= issue.getIssueId() %>" class="action-button2">View</a>
                                    </td>
                                </tr>
                                <%
                                    }
