                                    ...
                                    <tbody>
                                        <c:forEach items="${classes}" var="class1">
                                            <tr>
                                                ...
                                                <td>${class1.semesterId}</td>
                                                <td>${class1.subjectId}</td>
                                                <td>
                                                    <a href="/IMS-G4/edit-issue?issueId=$" class="btn btn-primary action-button1">Edit</a>
                                                    <a href="/IMS-G4/issue-details?issueId=" class="btn btn-primary action-button2">View</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
